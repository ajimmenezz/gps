      ...
      <div class=" col-12">
        ...
        <div class="card">
            <div class="card-header row">
              <div class="col-6">
              <h5 class=" float-left" v-if="accion!='editar'">Crear usuario</h5>
              <h5 class=" float-left" v-if="accion=='editar'">Editar usuario</h5>
              </div>
                  ...
                  <div>
                      ...
                      <div id="step-1" class="mpConf" >
                        <div class="row">
                          ...
                          <div class="col-12">  <p class="text-muted" style="text-align: justify; font-size: 12px; margin-top: 7px;"  v-if="accion=='editar'">
             A continuación podras consultar y modifcar los datos personales del usuario, agregar/quitar los permisos que tiene en la plataforma asi como que dispositivos que podrá visulizar y monitorear</p>
             <p class="text-muted" style="text-align: justify; font-size: 12px; margin-top: 7px;"  v-else>
             A continuación podras registrar los datos personales del usuario, agregarle los permisos que tendrá en la plataforma asi como que dispositivos que podrá visulizar y monitorear</p>
             </div>
                        ...
                        <div class="row">
                         ...
                         <div class="row" style="margin-top: 30px;">
                          <div class="col-6" >
                            <button class="btn btn-secondary float-left" @click="cancel()" style=" position: absolute; z-index: 10000;">CANCELAR</button>
                          </div>
                        </div>
                          ...
                          <!-- <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tipoUser" v-model="tipoUser">
                                        <option value="0">Selecciona</option>
             ...
             A continuación podras agregar o quitar los permisos que tendrá el usuario en la plataforma asi como que dispositivos que podrá visulizar y monitorear.</p>
                              ...
                              <div class="row">
                                <div class="col custom-control custom-checkbox">
                                  <input
                                    ...
                                    id="Check-1" value="1" v-model="permisos">
                                  <label class="custom-control-label" for="Check-1">Localización</label>
                                </div>
                                <div class="col custom-control custom-checkbox">
                                  <input
                                    type="checkbox"
                                    class="custom-control-input"
                                    id="Check-2" value="2" v-model="permisos" >
                                  <label class="custom-control-label" for="Check-2" >Reportes</label>
                                </div>
                                <div class="col custom-control custom-checkbox">
                                  <input
                                    type="checkbox"
                                    class="custom-control-input"
                                    id="Check-3" value="3" v-model="permisos">
                                  <label class="custom-control-label" for="Check-3">Alertas</label>
                                </div>
                                <div class="col custom-control custom-checkbox">
                                  <input
                                    type="checkbox"
                                    class="custom-control-input"
                                    id="Check-4" value="4" v-model="permisos">
                                  <label class="custom-control-label" for="Check-4">Configuración</label>
                                </div>
                              </div>
                            </div> -->
                            ...
                            <div class="col-12">
                               ...
                               <select id="permisos" class="js-example-basic-multiple col-sm-12" multiple="multiple">
                                  ...
                                  <option value="4">Paro de motor</option>
                                  <option value="5">Contraseña de eventos de dispositivo</option>
                                  <option value="6">Configuración dispositivo</option>
                                  <option value="7">Gestión flotillas</option>
                                  <option value="8">Gestión usuarios</option> -->
                          ...
                          <div class="row" v-if="this.$store.state.clientType==1">
                            ...
                            <div class="col-12">  <p class="text-muted" style="text-align: justify; font-size: 12px; margin-top: 7px;">
             A continuación podrás seleccionar que dispositivos podrá visualizar el usuario</p></div>
                       ...
                       <div class="col-12">
                          ...
                          <div class="row  justify-content-center">
                            <div class="col-6 " style="margin-top: 30px;     text-align: center;">
                              ...
                              <button class="btn btn-primary " @click="register()" v-if="accion!=='editar'" type="submit">REGISTRAR</button>
                              <button class="btn btn-primary " @click="editar()" v-if="accion==='editar'" type="submit">EDITAR</button>
                              <!-- <button class="btn btn-secondary float-left" @click="cancel()" style=" position: absolute; z-index: 10000;">CANCELAR</button>
                            </div>
                            <div class="col-6" >
                              <button class="btn btn-primary float-right" @click="register()" v-if="accion!=='editar'">REGISTRAR</button>
