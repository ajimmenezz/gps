  ...
  <div class="row" >
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="col-6" >
                <h5 class=" float-left" >Eliminar a <b>{{this.$store.state.modal.datosDymanic.nameCliente}}</b></h5>
                </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12" style="margin-top:30px;" >
                                          <h5 class="float-left">Productos a recuperar</h5>
                                          <hr style="margin-top: 2rem;">
                                      </div>
      ...
      <!-- fin gps -->
                   ...
                   <div class="col-12 col-sm-4" v-if="getTipoProduct==2">
                      <div class="form-group">
      ...
      <!-- producto -->
           ...
           <div class="col-12 col-sm-6" v-if="getTipoProduct==3">
                  ...
                  <!-- fin prducto -->
                    <div class="col-7 col-sm-4" v-if="getTipoProduct!=0">
                      <div class="form-group" >
            ...
            <div class="col-4 col-sm-3" v-if="getTipoProduct!=0 ">
            <button style="margin-top: 30px;"  type="button" class=" shadow-2 mb-4 btn btn-primary" @click="funproductoSeleted()" >AGREGAR</button>
          </div>
                  ...
                  <td>
                    <span>
                      ...
                      ></i>
                            ...
                            <div class="col-12 " style="margin-top: 15px;" >
                                <button class="btn btn-secondary shadow-2 mb-4 float-left" @click="goReturn()" >CANCELAR</button>
                                <button class="btn btn-primary shadow-2 mb-4 float-right" @click="SendForm()" type="submit" >CONFIRMAR</button>
                            </div>
...
export default {
  ...
  async mounted () {
    ...
    if (this.$store.state.modal.datosDymanic.seccion == 2) {
      ...
      this.title = 'Eliminar distribuidor'
    }
