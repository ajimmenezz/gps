              ...
              <div class="modal-body ">
                ...
                <div class="container">
                    ...
                    <div class="col-12 float-left"  style="color: #007bff;">
                        <h5  style="color: #007bff;" class="modal-title" id="exampleModalCenterTitle">Eliminar {{tipo}}</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-1"></div>
                    <div class="col-12" id="alertDelete"></div>
                  </div>

                  <div class="row">
                     <div class="col-12">
                      <button type="button" class="btn btn-outline-primary " data-dismiss="modal" @click="cancel()">CANCELAR</button>
                      <button type="button" id="btnRegist" class="btn btn-primary" @click="confirmModal()">ACEPTAR</button>
