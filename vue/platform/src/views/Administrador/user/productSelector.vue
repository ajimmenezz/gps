...
<div class="row">
  ...
  <!-- <div id="selectAll" style="display:none;">Selecciona todos los productos</div> -->
  <div class="w-100"></div>
  <div class="col-6 col-lg-3" >
    <m-select
...
import mAutocomplete from '@/components/basico/m.autocompleteDelete.vue'
...
export default {
  ...
  methods: {
    ...
    async getProducts () {
      ...
      // this.product.store.push({ id: 'Selecciona todo' })
      console.debug(' this.product.store', this.product.store)
    ...
    onProductSelected (product) {
      ...
      console.debug('onProductSelected1', product, this.product.selected)
    },
    addProduct () {
      if (this.product.selected) {
        console.debug('OnProductSelected2', this.product.selected)
