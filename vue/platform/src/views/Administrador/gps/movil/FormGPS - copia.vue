<template>
    ...
    <div id="modalAdminGPS" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog  modal-lg" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle" v-if="this.accion=='nuevo'">Nuevo GPS</h5>
                  <h5 class="modal-title" id="exampleModalCenterTitle" v-if="this.accion=='editar'">Editar GPS</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              </div>
               <form @submit.prevent >
              <div class="modal-body float-left" >

                <p v-if="this.$store.state.modal.datosDymanic.idCliente != 0" class="text-muted">El gps se agregará en el almacén del cliente: <b>{{this.$store.state.modal.datosDymanic.nameClient}}</b></p>
                <p v-else>El gps se agregará en tú almacén</p>

                  <!-- <div class="row">
                     <div class="col-12">
                        <h5 class="float-left">Asignar a:</h5>
                      </div>

                      <div class="col-6 col-sm-4 custom-control custom-radio" style="margin-left: 15px;">
                          <input type="radio" id="1" name="customRadio" class="custom-control-input" value="1" v-model="comportamiento">
                          <label class="custom-control-label" for="1">Almacen</label>
                      </div>
                      <div class="col-6 col-sm-4 custom-control custom-radio">
                          <input type="radio" id="2" name="customRadio" class="custom-control-input" value="2" v-model="comportamiento">
                          <label class="custom-control-label" for="2">Cliente</label>
                      </div>
                  </div> -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <config-input  id="imei" label="IMEI"  typeinput="text"  placeholder="IMEI" v-model.trim="imei" required="true" :valor="imei" v-if="this.accion=='nuevo'"></config-input>
              ...
              <div class="modal-footer">
                   <button class="btn btn-secondary shadow-2 mb-4 float-left" @click="cancel()" >CANCELAR</button>
                    <button class="btn btn-primary shadow-2 mb-4 float-right" @click="SendForm()" type="submit" v-if="this.$store.state.modal.datosDymanic.accion === 'nuevo'" >REGISTRAR</button>
...
export default {
   ...
   */
    async modelGPS () {
      ...
      if (this.marca == 3) {
        this.messageInfoImei = 'El imei de los GPS SUNTECH se compone por 16 digitos, de los cuales solo se ingresan los últimos 9 digitos.'
        this.exampleImei = ' xxx-xxx-x12-346-678-9'
      }
