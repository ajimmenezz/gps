                       ...
                       <div class="col-12"  v-show="!isEmptyReports">
                              ...
                              <div class="row">
                                <span style="  content: '';
                                  ...
                                  width: 4px;
                                  height: 20px;"></span>
                               <h5 class="float-left" style="margin-left: 20px;">Promedio nivel de bateria</h5>
                              </div>
      ...
      switch (opc) {
        case 1://  mes
          ...
          Object.entries(this.reports.monthPeriods).forEach(([key, ele]) => {
            dataAll.push(ele.batteryAverage)
            dataAll2.push(ele.powerSupplyAverage)
          })
