                       ...
                       <div class="col-12"  v-show="!isEmptyReports">
                              ...
                              <div class="row">
                                <span style="  content: '';
                                  ...
                                  width: 4px;
                                  height: 20px;"></span>
                               <h5 class="float-left" style="margin-left: 20px;">Tiempo de ralenti</h5>
                              </div>
...
export default {
  ...
  methods: {
    ...
    async getDataGraph (filters) {
      ...
      console.debug('RESUTALDO_R_GRAFICS', this.reports)
      ...
      switch (opc) {
        case 1://  mes
          ...
          Object.entries(this.reports.monthPeriods).forEach(([key, ele]) => {
            dataAll.push(ele.ralentiTime.hours)
            dataAll2.push(ele.maxRalentiTime.hours)
          })

          datoAll.push({
            name: this.reports.device.alias + ' - Tiempo total ralenti',
            data: dataAll
          })
          datoAll.push({
            name: this.reports.device.alias + ' - Tiempo maximo ralenti',
            data: dataAll2
          })
