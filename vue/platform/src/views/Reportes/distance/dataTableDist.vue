<template>
    <div class="col-12"  style="margin-top: 50px;">
      ...
      <div class="col-12" v-if="!isEmptyReports" > <h5 class="float-left text-muted" style="font-size: 20px; padding-bottom: 10px;"><b>Distancia recorrida</b></h5></div>
                                                ...
                                                <table id="zero-configuration" class="display table nowrap table-striped table-hover" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Distancia promedio por día</th>
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item,index) in gwtData" :key="index">
                                                            ...
                                                            <td>{{item.to.date}}</td>
                                                            <td>{{item.distanceTraveled}} km</td>
                                                            <td>{{item.distanceTraveledAverage}} km</td>
                                                        </tr>
